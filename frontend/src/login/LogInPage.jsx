...
const SCOPE = encodeURIComponent(
	'user-read-playback-state user-modify-playback-state user-read-currently-playing streaming playlist-read-private playlist-read-collaborative user-read-playback-position user-read-email user-read-private playlist-modify-private playlist-modify-public'
);
...
/**
 * Log in page where users can sign in to Earbuddies.
 * @returns {JSX.Element} Returns the JSX element for the login page.
 */
function LogInPage() {
	return (
		<div className={styles.page}>
			<img
				...
				alt='Spotify and Ear Buddies Logo'
			/>
